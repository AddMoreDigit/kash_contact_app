...
export function CorporateSidebar({ activePage, onNavigate, onLogout }: CorporateSidebarProps) {
  return (
    <aside className="w-[240px] bg-white border-r border-gray-200 flex flex-col">
      ...
      <nav className="flex-1 px-3 space-y-1">
        <SidebarItem
          ...
          label="Dashboard"
          active={activePage === 'dashboard' || activePage === 'corporateDashboard'}
        ...
        <SidebarItem
          ...
          label="Campaigns"
          active={activePage === 'campaigns' || activePage === 'corporateCampaigns'}
        ...
        <SidebarItem
          ...
          label="Vouchers"
          active={activePage === 'vouchers' || activePage === 'corporateVouchers'}
          onClick={() => onNavigate('corporateVouchers')}
        />
        <SidebarItem
          icon={
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          label="Transactions"
          active={activePage === 'transactions' || activePage === 'corporateTransactions'}
          onClick={() => onNavigate('corporateTransactions')}
        />
        <SidebarItem
          icon={
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          label="Profile"
          active={activePage === 'profile' || activePage === 'corporateProfile'}
        ...
        <SidebarItem
          ...
          label="Draft"
          active={activePage === 'draft' || activePage === 'corporateDrafts'}
          onClick={() => onNavigate('corporateDrafts')}
        />
      </nav>
      ...
      <div className="p-3 border-t border-gray-200">
        <SidebarItem
          ...
          label="Help"
          active={activePage === 'helpSupport' || activePage === 'corporateHelpSupport'}
          onClick={() => onNavigate('corporateHelpSupport')}
        />
